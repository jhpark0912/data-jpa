...
class MemberRepositoryTest {
    ...
    public void projections() throws Exception {
        ...
        result.forEach(u -> System.out.println("usernameOnly = " + u.getUsername() + "teamname" + u.getTeam().getName()));
    ...
    public void nativeQuery() throws Exception {
        ...
        List<MemberProjection> result = page.getContent();
        result.forEach(r -> System.out.println("result = " + r.getUsername() + " teamName = " + r.getTeamName()));
       ;
        //then
